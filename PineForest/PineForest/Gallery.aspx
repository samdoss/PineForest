<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gallery.aspx.cs" Inherits="PineForest.Gallery" %>
...
<head runat="server">
    ...
    <title>Pine Forest Gallery</title>
    <style type="text/css">
        <!--
...
<body>
    <form>
        ...
        <div id="bg">
            <div id="goback"><a href="Default.aspx">Back</a></div>
            <a href="#" class="nextImageBtn" title="next"></a><a href="#" class="prevImageBtn" title="previous"></a>
            <img src="gimages/1.jpg" width="1680" height="1050" alt="Pine Forest" title="Pine Forest" id="bgimg" />
        </div>
        <div id="preloader">
            ...
            <div id="outer_container">
                <div class="thumbScroller">
                    <div class="container">
                        ...
                        <div class="content">
                            <div>
                                <a href="gimages/4.jpg">
                                    <img src="gimages/4_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/5.jpg">
                                    <img src="gimages/5_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/6.jpg">
                                    <img src="gimages/6_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/7.jpg">
                                    <img src="gimages/7_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/8.jpg">
                                    <img src="gimages/8_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/9.jpg">
                                    <img src="gimages/9_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/10.jpg">
                                    <img src="gimages/10_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/11.jpg">
                                    <img src="gimages/11_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/12.jpg">
                                    <img src="gimages/12_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/13.jpg">
                                    <img src="gimages/13_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/14.jpg">
                                    <img src="gimages/14_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/15.jpg">
                                    <img src="gimages/15_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <a href="gimages/16.jpg">
                                    <img src="gimages/16_thumb.jpg" title="Pine Forest" alt="Pine Forest" class="thumb" /></a>
                            </div>
                        </div>
