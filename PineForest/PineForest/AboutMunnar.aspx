<%@ Page Title="" Language="C#" MasterPageFile="~/Pine.Master" AutoEventWireup="true" CodeBehind="AboutMunnar.aspx.cs" Inherits="PineForest.AboutMunnar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="server">
    <title>Pine Forest Munnar | About Munnar</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenu" runat="server">
    <ul>
        <li><a class="scroll" href="Default.aspx">HOME</a></li>
        <li><a class="scroll" href="facilities.aspx">FACILITIES</a></li>
        <li class="active"><a class="scroll" href="aboutmunnar.aspx">ABOUT MUNNAR</a></li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cpContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="main">
            <h3>MUNNAR - Fact File</h3>

            Altitude : 1600 Mts to 1800 Mts above sea level
            <br />
            Tourist Season : August to May<br />
            Clothing : Warm Clothes and Rain Gear<br />
            Temperature : Min. 0 c - Max. 25 c<br />
        </div>
    </div>
</asp:Content>
